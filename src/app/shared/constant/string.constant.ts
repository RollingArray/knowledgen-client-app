...
export class StringKey {
	...
	public static readonly MORE_THAN: string = ">";
	public static readonly LESS_THAN: string = "<";
	...
	public static readonly TASK_REVIEW_FORM_INFO: string = 'Update the following review details for the task';
	public static readonly CREATE_REVIEW: string = 'Create Review';
	public static readonly UPDATE_REVIEW: string = 'Update Review';



	public static readonly TASK_KEY_COMPLETION_INDICATOR: string = 'Task Key Completion Parameters';
	public static readonly TASK_ACHIEVED_FACT: string = 'Task Achieved Fact';
	public static readonly TASK_ASSIGNEE_COMMENT: string = 'Assignee Comment';
	public static readonly TASK_ASSIGNEE: string = 'Assigned To';
	public static readonly TASK_REVIEWER: string = 'Task Reviewer(s)';

	public static readonly SEARCH_PROJECT: string = 'Search Project';
	...
	public static readonly POOR: string = 'Poor';
	public static readonly IMPROVEMENT: string = 'Improvement';
	public static readonly EXPECTATION: string = 'Expectation';
	...
	public static readonly FORM_INFO_SPRINT_NAME: string = 'Provide a suitable name for the sprint';
	public static readonly FORM_INFO_SPRINT_START_DATE: string = 'Provide the start date of the sprint';
	public static readonly FORM_INFO_SPRINT_END_DATE: string = 'Provide the end date of the sprint';

	public static readonly FORM_INFO_GOAL_NAME: string = 'Provide a suitable name for the goal';
	public static readonly FORM_INFO_GOAL_DESCRIPTION: string = 'Provide a suitable description for the goal';
	public static readonly FORM_INFO_GOAL_END_DATE: string = 'Provide the end date of the goal';
	...
	public static readonly FORM_PLACEHOLDER_SPRINT_NAME: string = 'Period Jan - March 2020';
	public static readonly FORM_PLACEHOLDER_SPRINT_START_DATE: string = '01/01/2020';
	public static readonly FORM_PLACEHOLDER_SPRINT_END_DATE: string = '31/03/2020';

	public static readonly FORM_PLACEHOLDER_GOAL_NAME: string = 'Simplify internal procedures';
	public static readonly FORM_PLACEHOLDER_GOAL_DESCRIPTION: string = 'Simplify internal procedures and make financial reporting more transparent';
	...
	public static readonly FORM_PLACEHOLDER_TASK_KEY_COMPLETION_INDICATOR: string = 'Should be able to complete minimum number of proposals';
	public static readonly FORM_PLACEHOLDER_REVIEWER_COMMENT: string = 'Task was 100% completed';
	...
	public static readonly FORM_VALIDATION_PROJECT_DESCRIPTION: string = 'It is a mandatory filed. Only [A-Z] [a-z] [0-9] [space,/()] allowed';

	public static readonly FORM_VALIDATION_SPRINT_NAME: string = 'It is a mandatory filed. Only [A-Z] [a-z] [0-9] [space] allowed';
	public static readonly FORM_VALIDATION_SPRINT_START_DATE: string = 'It is a mandatory filed. Only date allowed';
	public static readonly FORM_VALIDATION_SPRINT_END_DATE: string = 'It is a mandatory filed. Only date allowed';

	public static readonly FORM_VALIDATION_GOAL_NAME: string = 'It is a mandatory filed. Only [A-Z] [a-z] [0-9] [space] allowed';
	public static readonly FORM_VALIDATION_GOAL_DESCRIPTION: string = 'It is a mandatory filed. Only [A-Z] [a-z] [0-9] [space,/()] allowed';
	...
	public static readonly ICON_DURATION: string = StringKey.ICON_BASE_PATH + "duration.svg";
	...
	public static readonly ICON_STUDENT: string = StringKey.ICON_BASE_PATH + "student.svg";
